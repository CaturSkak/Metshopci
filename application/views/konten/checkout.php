                        ...
                        <div id="checkout-login" class="coupon-content">
                            <div class="coupon-info">
                                ...
                                <form action="#">
                                    ...
                                    <!-- Lost Password Start -->
                                    <p class="lost-password"><a href="<?php echo base_url();?>#"><strong>Lupa Password?</strong></a></p>
                                    <!-- Lost Password End -->
                    ...
                    <div class="your-order-area border">
                        ...
                        <div class="single-payment">
                                    <h5 class="panel-title mb-3">
                                        <a class="collapse-off" data-bs-toggle="collapse" href="<?php echo base_url();?>#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                            Bank Tranfer
                                        </a>
                                    </h5>
                               ...
                               <label class="fit-image ms-1"><input required type="radio" class="pixel-radio ml-auto align-self-center mb-3"  type="radio"></input  type="radio" name="tipebayar" value="bri" required><a> &nbsp;&nbsp;</a><img src="<?php echo base_url();?>assets/images/payment/mdr.png" class="bank-icon rounded-circle"><strong> &nbsp;&nbsp;Mandiri</strong> </label>
                             ...
                             <div class="card-body shadow-sm rounded d-flex mb-3" id="card-bank">
                               <label class="fit-image ms-1"><input required type="radio" class="pixel-radio ml-auto align-self-center mb-3"  type="radio"></input  type="radio" name="tipebayar" value="bri" required><a> &nbsp;&nbsp;&nbsp;&nbsp;</a><img src="<?php echo base_url();?>assets/images/payment/bnii.png" class="bank-icon rounded-circle"><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BNI</strong> </label>
                                ...
                                <div class="single-payment">
                                    <h5 class="panel-title mb-3">
                                        <a class="collapse-off" data-bs-toggle="collapse" href="<?php echo base_url();?>#collapseExample-2" aria-expanded="false" aria-controls="collapseExample-2">
                                            Uang Digital
                                        </a>
                                    </h5>
                                ...
                                </input  type="radio" name="tipebayar" value="bri" required><a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><img src="<?php echo base_url();?>assets/images/payment/oppo.png" class="bank-icon rounded-circle"><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ovo</strong> </label>
                                
                            </div>

                             <div class="card-body shadow-sm rounded d-flex mb-3" id="card-bank">
                                <label class="fit-image ms-1"><input required type="radio" class="pixel-radio ml-auto align-self-center mb-3"  type="radio"></input  type="radio" name="tipebayar" value="bri" required><a> &nbsp;&nbsp;</a><img src="<?php echo base_url();?>assets/images/payment/gopay.png" class="bank-icon rounded-circle"><strong> &nbsp;&nbsp;&nbsp;&nbsp;Gopay</strong> </label>
