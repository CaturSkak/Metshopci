                    ...
                    <div class="row shop_wrapper grid_3">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <<div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kucing Anggora Asli</a></h5>
                                    <span class="rating">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kucing Anggora mix Persia</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                               ...
                               <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kucing Persia Asli</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kucing Mainecoon</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Anjing Chihuahua</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Anjing Shiba Inu</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Anjing Alaskan Malamute</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Anjing Siberian Husky</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kucing Himalaya</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Anjing Poddle</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Anjing Beagle</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                <li class="page-item">
                                        <a class="page-link rounded-0" href="<?php echo base_url();?>shop" aria-label="Previous">

                                        <span aria-hidden="false">&laquo;</span>
                                    </a>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shop">1</a></li>
                                    <li class="page-item"><a class="page-link active" href="<?php echo base_url();?>shop2">2</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shop3">3</a></li>
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="<?php echo base_url();?>shop3" aria-label="Next">
