                ...
                <div class="col-lg-9 col-12">
                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link active" href="<?php echo base_url();?>shoprightsidebar">1</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shoprightsidebar2">2</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shoprightsidebar3">3</a></li>
                                    <li class="page-item">
