                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                        <li class="page-item">
                                        <a class="page-link rounded-0" href="<?php echo base_url();?>shoplistfullwidth" aria-label="Next">
                                            <span aria-hidden="true">&laquo;</span>
                                            </a>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shoplistfullwidth">1</a></li>
                                    <li class="page-item"><a class="page-link active" href="<?php echo base_url();?>shoplistfullwidth2">2</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shoplistfullwidth3">3</a></li>
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="<?php echo base_url();?>shop-list-fullwidth3" aria-label="Next">
                                    ...
                                    <ul class="checkbox-container categories-list">
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck12">Kakatua (1)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck13">
                                                <label class="custom-control-label" for="customCheck13">Beo (1)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck14">
                                                <label class="custom-control-label" for="customCheck14">Love Bird (1)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck11">
                                                <label class="custom-control-label" for="customCheck11">Merpati (1)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck15">
                                                <label class="custom-control-label" for="customCheck15">Parkit (1)</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
