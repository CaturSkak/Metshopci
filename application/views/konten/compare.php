                                    ...
                                    <tr>
                                        ...
                                        <td class="product-image-title">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/Iguana Hijau.png" alt="Compare Product">
                                            </a>
                                        ...
                                        <td class="product-image-title">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/Iguana Hijau Albino.png" alt="Compare Product">
                                            </a>
                                            <a href="#/" class="category mb-1">Reptil</a>
                                        ...
                                        <td class="product-image-title">
                                            <a href="single-product.htmll" class="image">
                                                <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/red bearded.png" alt="Compare Product">
                                            </a>
                                            <a href="#/" class="category mb-1">Reptil</a>
