            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="breadcrumb-wrapper">
                        <h2 class="breadcrumb-title">Perjodohan Ikan Hias</h2>
                        <ul>
                ...
                <div class="col-lg-9 col-12">
                    ...
                    <div class="row shop_wrapper grid_3">
                            ...
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/koi4.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Koi Soragoi Ginrin</a></h5>
                                    <span class="rating">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/koi3.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Koi Chagoi Ginrin </a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/koi2.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Koi Shiro Utsuri</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Koi Kohaku</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Arwana Golden Green Pino</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/manfish.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="new">New</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Angelfish</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/pari1.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Pari Motoro </a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/pari2.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Pari Pearl Albino</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.165.000/Hari</span>
                                    </span>
                                    <p>There are many variations of passages of lorem ipsum, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                                    <!-- Cart Button Start -->
                                    <div class="cart-btn action-btn">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/koki.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Mas Koki Black Moor </a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/kokimet.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-18%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Mas Koki Komet </a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star-o"></i>
                                            <i class="fa fa-star-o"></i>
                                            <i class="fa fa-star-o"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/lohan.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Louhan</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/arwana2.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ikan Arwana Super Red</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link active" href="<?php echo base_url();?>shop-right-sidebar.php">1</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shop-right-sidebar2.php">2</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shop-right-sidebar3.php">3</a></li>
                                    <li class="page-item">
                                    ...
                                    <ul class="checkbox-container categories-list">
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck12">Ikan Angelfish (20)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck13">
                                                <label class="custom-control-label" for="customCheck13">Ikan Arwana Golden Green.... (6)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck14">
                                                <label class="custom-control-label" for="customCheck14">Ikan Pari Pearl Albino (8)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck11">
                                                <label class="custom-control-label" for="customCheck11">Ikan Louhan (5)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck15">
                                                <label class="custom-control-label" for="customCheck15">Ikan Arwana Super Red (4)</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="sidebar-body product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/pari2.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.html">Ikan Pari Pearl Albino</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.165.000/Hari</span>
                                            </span>
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/arwana2.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.html">Ikan Arwana Super Red</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.55.000/Hari</span>
                                            </span>
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/lohan.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.html">Ikan Louhan</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.55.000/Hari</span>
