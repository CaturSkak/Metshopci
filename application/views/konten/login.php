            ...
            <div class="row">
                <div class="col-lg-7 col-md-8 m-auto">
                    ...
                    <div class="login-wrapper">
                        ...
                        <!-- Form Action Start -->
                        <form action="<?php echo base_url('authcustomer'); ?>" method="post">
                            ...
                            <div class="single-input-item mb-3">
                                ...
                                <a href="<?php echo base_url('authcustomer/registrasi'); ?>"><strong>Daftar Sekarang</strong></a> -->
                                <div class="bottom">
                                    <span class="helper-text m-b-10"><i class="fa fa-lock"></i><a href="<?php echo base_url('authcustomer/lupasandi'); ?>"> Lupa Kata Sandi ?</a></span> <BR>
                                    <span>Tidak Punya Akun? <a href="<?php echo base_url('authcustomer/registrasi'); ?>">Daftar</a></span>
                                </div>
                            </div>
