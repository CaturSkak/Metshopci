            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="breadcrumb-wrapper">
                        <h2 class="breadcrumb-title">Perjodohan Reptil</h2>
                        <ul>
                            <li><a href="<?php echo base_url();?>index.php">Beranda</a></li>
                            <li>Perjodohan Reptil</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row shop_wrapper grid_3">
                            ...
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/Iguana Hijau Albino.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Iguana Hijau Albino</a></h5>
                                    <span class="rating">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/Tokek.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Tokek </a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/Iguana Hijau.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Iguana Hijau</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.100.000/Hari</span>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Chameleon Veiled</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.170.000/Hari</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ular Retic Tiger Albino</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.120.000/Hari</span>
                            ...
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/caiman.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Buaya Caiman</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.550.000/Hari</span>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/kurapan.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kura Kura Leher Panjang</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.40.000/Hari</span>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/kurabraz.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kura Kura Brazil</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star-half-o"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.50.000/Hari</span>
                                    </span>
                                    <p>There are many variations of passages of lorem ipsum, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                                    <!-- Cart Button Start -->
                                    <div class="cart-btn action-btn">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/rebelson.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Kura Kura Red Belly Nelsoni</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.60.000/Hari</span>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/mabelo.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-18%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Ular Mata Belo </a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star-o"></i>
                                            <i class="fa fa-star-o"></i>
                                            <i class="fa fa-star-o"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.10.000/Hari</span>
                                    </span>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                    <!-- Cart Button Start -->
                                    <div class="cart-btn action-btn">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/pitonijo.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.html">Ular Python Pohon Hijau</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <span class="price">
                                            <span class="new">Rp.70.000/Hari</span>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/red bearded.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Bearded Dragon Super Red</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star-half-o"></i>
                                ...
                                <div class="sidebar-body product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/Chameleon.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.html">Chameleon Veiled</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.170.000/Hari</span>
                                            </span>
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/Iguana Hijau.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.html">Iguana Hijau</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.100.000/Hari</span>
                                            </span>
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/red bearded.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.html">Bearded Dragon Super Red</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.150.000/Hari</span>
