                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="social-share">
                            <div class="widget-social justify-content-start mb-6">
                                ...
                                <a title="Whatsapps" href="<?php echo base_url();?>https://api.whatsapp.com/send?phone=6282229434533&text=Saya%20berminat%20memesan%20Apakah%20produk%20tersedia?"><i class="fa fa-whatsapp"></i></a>
                            </div>
                        </div>
                        <!-- Social Shear End -->
                ...
                <div class="col-lg-12 single-product-tab">
                    <ul class="nav nav-tabs mb-n3" id="myTab" role="tablist">
                        <li class="nav-item mb-3">
                            <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="<?php echo base_url();?>#connect-1" role="tab" aria-selected="true">Deskripsi & Syarat Jodoh</a>
                        </li>
                        <li class="nav-item mb-3">
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="<?php echo base_url();?>#connect-2" role="tab" aria-selected="false">Ulasan</a>
                        </li>
                        <li class="nav-item mb-3">
                            <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="<?php echo base_url();?>#connect-3" role="tab" aria-selected="false">Aturan Pengiriman</a>
                        </li>
                        ...
                        <div class="tab-pane fade" id="connect-3" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="shipping-policy mt-8 mb-n3">
                                ...
                                <ul class="policy-list mb-3">
                                    ...
                                    <li><a href="<?php echo base_url();?>#">Free Tempat Makan & Minum</a></li>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product">
                                            ...
                                            <!-- Content Start  -->
                                            <div class="content">
                                                <h5 class="title"><a href="<?php echo base_url();?>liathewanjodoh">Anjing Alasakan Malamute</a></h5>
                                                <span class="rating">
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                        ...
                        <ul class="mobile-menu">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li><a href="<?php echo base_url();?>keranjangjodoh.php">Shopping Cart</a></li>
