                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                               <ul class="pagination">
                                <li class="page-item">
                                    <a class="page-link rounded-0" href="<?php echo base_url();?>shopleftsidebar2" aria-label="Previous">
                                      <span aria-hidden="true">&laquo;</span>
                                    </a>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shopleftsidebar">1</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shopleftsidebar2">2</a></li>
                                    <li class="page-item"><a class="page-link active" href="<?php echo base_url();?>shopleftsidebar3">3</a></li>
                                    <li class="page-item">
                                    </li>
                                </ul>
                            </nav>
