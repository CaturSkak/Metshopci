                ...
                <div class="col-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="pro-title"><a href="<?php echo base_url();?>#">Anjing Shiba Inu</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="pro-title"><a href="<?php echo base_url();?>#">Kucing Anggora Asli</a></td>
                    ...
                    <div class="cart-button-section mb-n4">
                        ...
                        <div class="cart-btn-lef-side mb-4">
                            <a href="<?php echo base_url();?>#" class="btn btn btn-gray-deep btn-hover-primary">Belanja Lagi</a>
                            <a href="<?php echo base_url();?>#" class="btn btn btn-gray-deep btn-hover-primary">Perbarui daftar Keranjang</a>
                        </div>
                        <!-- Cart Button left Side End -->

                        <!-- Cart Button Right Side Start -->
                        <div class="cart-btn-right-right mb-4">
                            <a href="<?php echo base_url();?>#" class="btn btn btn-gray-deep btn-hover-primary">Hapus Daftar Keranjang</a>
                        </div>
