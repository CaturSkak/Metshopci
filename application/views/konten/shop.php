                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item">
                                    <li class="page-item"><a class="page-link active" href="<?php echo base_url();?>shop">1</a></li>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="<?php echo base_url();?>shop2" aria-label="Next">
