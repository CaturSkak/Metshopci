                ...
                <div class="col-lg-9 col-12">
                    ...
                    <div class="row shop_wrapper grid_3">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Love Bird</a></h5>
                                    <span class="rating">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/dara.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Dara</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/merpati.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Merpati</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/tekukur.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-18%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Tekukur</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Kakatua</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/beo.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="new">Baru</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Beo</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/cucak ijo.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Cucak Hijau</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/jalak bali.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Jalak Bali</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star-half-o"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/serak jawa.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Hantu Serak Jawa</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/cendet.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-18%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Cendet</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.html" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/parkit.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.html">Burung Parkit</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?php echo base_url();?>single-product.php" class="image">
                                        <img class="fit-image" src="<?php echo base_url();?>assets/images/products/medium-product/pleci.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="<?php echo base_url();?>#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="<?php echo base_url();?>wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="<?php echo base_url();?>single-product.php">Burung Pleci</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star-half-o"></i>
                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link active" href="<?php echo base_url();?>shop-list-fullwidth.php">1</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shop-list-fullwidth2.php">2</a></li>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>shop-list-fullwidth3.php">3</a></li>
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="<?php echo base_url();?>shop-list-fullwidth2.php" aria-label="Next">
                                    ...
                                    <ul class="checkbox-container categories-list">
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck12">Burung Kakatua (10)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck13">
                                                <label class="custom-control-label" for="customCheck13">Burung Beo (1)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck14">
                                                <label class="custom-control-label" for="customCheck14">Burung Love Bird (1)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck11">
                                                <label class="custom-control-label" for="customCheck11">Burung Merpati (1)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck15">
                                                <label class="custom-control-label" for="customCheck15">Burung Parkit (1)</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="sidebar-body product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/kakatua.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.php">Burung Kakatua</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.200.000/Hari</span>
                                            </span>
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.php" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/love bird.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.php">Burung Love Bird</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.25.000/Hari</span>
                                            </span>
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="<?php echo base_url();?>single-product.html" class="image">
                                                    <img class="fit-image first-image" src="<?php echo base_url();?>assets/images/products/medium-product/parkit.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
                                        ...
                                        <div class="product-list-content">
                                            <h6 class="product-name">
                                                <a href="<?php echo base_url();?>single-product.html">Burung Parkit</a>
                                            </h6>
                                            <span class="price">
                                                    <span class="new">Rp.35.000/Hari</span>
