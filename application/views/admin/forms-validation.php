        ...
        <div class="container-fluid">
            <div class="col-lg-16 col-md-16 col-sm-15">
                    <div class="card">
                        ...
                        <div class="body">
                       <a href="<?php echo base_url();?>formsbasic" class="btn btn-sm btn-primary" title="">Tambah Perjodohan</a>
                        </div>
                       <div class="body">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>                                            
                                                ...
                                                <a href="<?php echo base_url();?>formscropping" button type="button" class="btn btn-info"  title="Edit"><i class="fa fa-edit"></i></button></a>
