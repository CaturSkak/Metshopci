                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo base_url();?>formswizard">Edit Daftar Hewan</li></a>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <a href="<?php echo base_url();?>formsadvanced" button type="button"class="btn btn-block btn-primary m-t-20">Selesai</button></a>
                            </div>
                        </div>
                        </div>   
                </div>
