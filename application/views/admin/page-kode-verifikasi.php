            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="body">
                            <p>Silakan masukkan Kode Verifikasi.</p>
                            <form class="form-auth-small" action="BerandaAdmin">
                                <div class="form-group">                                    
                                    <input type="password" class="form-control" id="signup-password" placeholder="Kode Verifikasi">
                                </div>
                                <a href="<?php echo base_url();?>pagepulihkanpassword" button type="submit" class="btn btn-primary btn-lg btn-block">Selanjutnya</a></button>
                                <div class="bottom">
