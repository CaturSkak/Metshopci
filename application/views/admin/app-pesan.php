                        ...
                        <ul class="list-unstyled">
                            <li class="clearfix">
                                ...
                                <div class="mail-detail-right">
                                    <h6 class="sub"><a href="app-inbox-detail.php" class="mail-detail-expand">Admin</a></h6>
                                    </h6>
                    ...
                    <div class="mail-list">
                        <ul class="list-unstyled">
                            <li class="clearfix">
                                ...
                                <div class="mail-detail-right">
                                    <h6 class="sub"><a href="<?php echo base_url(); ?>appchat" class="mail-detail-expand">Muhammad Doni S.</a></h6>
                                    </h6>
